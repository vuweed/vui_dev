...
#define	RUN_ALL_MODE		(RUN_STA_MODE | RUN_AP_MODE | RUN_P2P_MODE)
#define	RUN_CONCURRENT_MODE	0x8
...
#define	APP_CM						"da16x_cm"
#define	APP_DEMO_SVR				"demo_svr"
#define	APP_OTA_SETUP				"ota_setup"
...
#define    CUSTOMER_PROVISIONING            "custom_provision"
...
#define	APP_DOORBELL_UART1			"doorbell_uart1"
#define	APP_DOORBELL_VA_TX			"doorbell_va_tx"
#define	APP_DOORBELL_IF				"doorbell_interface"
#define	APP_RTSP_DOORBELL			"doorbell_rtsp"
